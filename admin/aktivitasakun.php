...
<body>
  ...
  <body>
<?php
        $sql = "SELECT * FROM log ORDER BY id_log DESC LIMIT 20 ";
        ...
        <div class="px-4 py-5 px-md-5 text-center text-lg-start" >
          <div class="container">
            ...
            <div class="col">
              ...
              <h2 class="card-title">Aktivitas Akun</h2>
              </div>
              <div class="card-body">
              <div class="row">
              <div class="col-md-2">
              ...
              <tbody>
              <tr>
                <th><strong>Akun</h3></strong></td>
                <th><strong>Aktivitas</h3></strong></td>
          		<th><strong>Waktu</h3></strong></td>
              </tr>
            <?php while ($tampil = mysqli_fetch_array($data)){ ?>
            <tr>
                <td><?php echo $tampil['username']; ?></td>
                <td><?php echo $tampil['aktif']; ?></td>
